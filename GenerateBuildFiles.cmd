...
@ROBOCOPY %QTDIR%\bin %SD_TREE%\output\bin\release Qt5Core.dll Qt5Gui.dll Qt5Widgets.dll Qt5WinExtras.dll Qt5Concurrent.dll /NFL /NDL /NJH /NJS 1> nul

@ROBOCOPY %QTDIR%\bin %SD_TREE%\output\bin\debug Qt5Cored.dll Qt5Guid.dll Qt5Widgetsd.dll Qt5WinExtrasd.dll Qt5Concurrentd.dll Qt5Concurrentd.pdb Qt5Cored.pdb Qt5Guid.pdb Qt5Widgetsd.pdb Qt5WinExtrasd.pdb /NFL /NDL /NJH /NJS 1> nul
